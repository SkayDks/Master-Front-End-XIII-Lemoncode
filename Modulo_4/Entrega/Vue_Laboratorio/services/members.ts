...
export const membersService = {
  ...
  async getMemberById(id: string) {
     ...
     */
    const member = (): Promise<Member> => {
      return new Promise((resolve) => {
        resolve(fakeOnlyMember);
      });
    };
    return member();
  },
};
const fakeOnlyMember: Member = {
  login: "antonio06",
  id: 14540103,
